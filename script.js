...
function saveStudent(event) {
    ...
    if (!name ||
        ...
        message.textContent =
            "Please complete all student information fields.";
...
function addResult(event) {
    ...
    if (ca < 0 || ca > 40) {
        ...
        showResultError(
            "CA/Test score must be between 0 and 40."
        );
    ...
    if (exam < 0 || exam > 60) {
        ...
        showResultError(
            "Examination score must be between 0 and 60."
        );
...
function changeGalleryMessage() {
    ...
    if (!galleryChanged) {
        ...
        message.textContent =
            "StudentHub promotes learning, collaboration and academic excellence.";
        ...
        message.textContent =
            "Welcome to the StudentHub Gallery.";
